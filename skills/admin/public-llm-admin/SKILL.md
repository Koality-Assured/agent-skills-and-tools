...
contracts:
  inputs:
  - Vendor workspace or project, audit or key-lifecycle action, spend/ZDR scope, and explicit human authorization for key changes
  outputs:
  - Workspace/key inventory, ZDR and spend findings, authorized rotation results, or an explicit no-change decision
