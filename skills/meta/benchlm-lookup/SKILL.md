...
contracts:
  inputs:
    - BenchLM category, provider, price/speed filters, sort order, and result limit
  outputs:
    - Filtered benchmark comparison, price-to-performance notes, and provenance caveats
---
