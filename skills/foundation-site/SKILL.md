...
contracts:
  inputs:
    - Host report path (assembled md or html), output run dir, and CDN vs local flag
  outputs:
    - Designed Foundation Sites index.html beside the host report (tables, callouts, no leaked frontmatter)
---
...
- Artifact links to other repo files: [`github-paths`](../github-paths/SKILL.md) / [`supporting/github/github-paths.md`](../../../supporting/github/github-paths.md)
...
6. Links in the HTML/MD to **other repo files** (threat model, diagrams, standards) **MUST** be GitHub `blob/main` / `tree/main` URLs via [`github-paths`](../github-paths/SKILL.md) — not `../` relatives or local OS paths.
