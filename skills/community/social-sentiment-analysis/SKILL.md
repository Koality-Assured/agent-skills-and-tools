...
contracts:
  inputs:
    - Model, framework, or tool name, optional platform list, and lookback window
  outputs:
    - Sentiment and consensus summary with cited public threads; no private or employee communications
---
