...
contracts:
  inputs:
    - Ecosystem sector and opportunity lens (pain points, tooling gap, indie alternatives)
  outputs:
    - Opportunity notes with cited discussions and an explicit no-opportunity decision when the field is empty
---
