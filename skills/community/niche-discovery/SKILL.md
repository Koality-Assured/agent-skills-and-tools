...
contracts:
  inputs:
    ...
    properties:
      domain:
        type: string
        description: Domain or capability need (e.g. CUDA kernels, AST transformers, local TTS, context compression)
      constraints:
        type: string
        description: License, runtime, or language requirements
  outputs:
    task_id: string
    status: string
    artifacts: list
