...
contracts:
  inputs:
    ...
    properties:
      target_entity:
        type: string
        description: Organization, public project, or technical initiative to investigate
      lens:
        type: string
        description: Focus area (e.g. infrastructure clues, release timeline, architecture shifts)
  outputs:
    task_id: string
    status: string
    artifacts: list
