...
contracts:
  inputs:
    - Codebase path, output run dir, and format (json/yaml/sarif) or --passive/--dry-run
  outputs:
    - Noir endpoint/attack-surface inventory beside the host code-review run (no remote-AI flags)
---
